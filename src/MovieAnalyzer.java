...
public class MovieAnalyzer {
  ...
  public MovieAnalyzer(String datasetPath) throws IOException {
    this.movies =  readMovies(datasetPath);
  }
  ...
  public Map<List<String>, Integer> getCoStarCount() {
    ...
    list.stream()
      .collect(Collectors
      .groupingBy(List::copyOf, Collectors
      .summingInt(e -> 1))).entrySet().stream()
  ...
  public List<String> getTopStars(int top_k, String by) {
    List<Star> starsR = new LinkedList<>();
  ...
  public static List<Movie> readMovies(String filename) throws IOException {
    ...
    return  Files.lines(Paths.get(filename))
                ...
                .map(l -> {
                  ...
                  if (l[7].startsWith("\"")) {
                    l[7] = l[7].substring(1, l[7].length() - 1);
                  }
                  if (l[8].equals("")) {
                    l[8] = "-1";
                  }
...
class Movie {
  ...
  public Movie(String seriesTitle, int releasedYear,
               String certificate, String runtime, String genre,
               float imdmRating, String overview, double metaScore,
               String director, String star1, String star2, String star3,
               String star4, long noOfVotes, String gross) {
